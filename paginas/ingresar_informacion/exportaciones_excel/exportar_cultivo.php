...
// Con el siguiente bloque de código podemos escribir en la casilla que deseamos, es muy sencillo el manejo tanto para hacerlo manualmente como dinámicamente.
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B8', $tipo_cultivo)
            ->setCellValue('C8', $nutriente_N)
            ->setCellValue('D8', $nutriente_P)
            ->setCellValue('E8', $nutriente_K)
            ->setCellValue('F8', $nutriente_Ca)
            ->setCellValue('G8', $nutriente_Mg)
            ->setCellValue('H8', $nutriente_S)
            ->setCellValue('I8', $nutriente_Zn)
            ->setCellValue('J8', $nutriente_B)
            ->setCellValue('K8', $nutriente_Cu);
...
header('Content-Disposition: attachment;filename="Formulario_Cultivo.xls"');
