...
// Luego de escribir en la hoja de cálculo pasamos a darle un nombre y definir con que hoja abrirá el documento, en este caso como tenemos solo uno, el valor será “0”.
            ...
            $objPHPExcel->getActiveSheet()->setTitle('Laboratorios_SIFFA');
$objPHPExcel->setActiveSheetIndex(0);


$connection=mysqli_connect("localhost","root","","siffa");
$query="SELECT Nombre_Laboratorio,Direccion, Telefono ,Nombre_Municipio, NombreDepartamento FROM `laboratorio` INNER JOIN municipio ON laboratorio.Idmunicipio=municipio.Idmunicipio INNER JOIN departamento ON municipio.Iddepartamento=departamento.Iddepartamento";
...
header('Content-Disposition: attachment;filename="Laboratorios_SIFFA.xls"');
