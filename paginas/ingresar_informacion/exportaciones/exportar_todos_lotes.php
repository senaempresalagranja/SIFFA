...
$sql="SELECT NumeroLote,latitud,longitud, Ha,Nombre,NombreVereda, Nombre_Municipio, NombreDepartamento,Tamano FROM `lote`  INNER JOIN Hacienda ON lote.IdHacienda=hacienda.Idhacienda INNER JOIN vereda ON hacienda.Idvereda=vereda.Idvereda INNER JOIN municipio ON vereda.Idmunicipio=municipio.Idmunicipio INNER JOIN departamento ON municipio.Iddepartamento=departamento.Iddepartamento  ORDER BY  Nombre,NumeroLote";
