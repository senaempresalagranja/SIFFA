...
$sql="SELECT * FROM cultivo INNER JOIN requerimiento ON cultivo.idrequerimiento=requerimiento.idrequerimiento INNER JOIN tipo_cultivo ON cultivo.Idtipo_cultivo=tipo_cultivo.Idtipo_cultivo";
...
<p></p>
<h1>CULTIVOS BASE DE DATOS SIFFA</h1>
<table >
			<tr>
...
// NOMBRE DEL ARCHIVO
$pdf->Output('Cultivos_SIFFA.pdf', 'I');
