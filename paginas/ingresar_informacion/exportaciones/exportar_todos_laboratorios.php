...
$sql="SELECT Nombre_Laboratorio,Direccion, Telefono ,Nombre_Municipio, NombreDepartamento FROM `laboratorio` INNER JOIN municipio ON laboratorio.Idmunicipio=municipio.Idmunicipio INNER JOIN departamento ON municipio.Iddepartamento=departamento.Iddepartamento";
...
<p></p>
<h1>LABORATORIOS BASE DE DATOS  SIFFA</h1>
<table >
			<tr>
...
// NOMBRE DEL ARCHIVO
$pdf->Output('Laboratorios_SIFFA.pdf', 'I');
