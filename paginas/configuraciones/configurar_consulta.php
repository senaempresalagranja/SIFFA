        ...
        <li  class="submenu"><a id="submenu" class="dr-icon dr-icon-pencil2"    href="#" >Captura de Datos</a>
          ...
          <li><a class="dr-icon dr-icon-eye" id="submenu1" href="#">Consultas</a>
            <ul class="children"  id="children1">
              ...
              <li><a href="../consultas/" class="dr-icon dr-icon-eye-plus">Analisis Guardado</a></li>
            ...
            <li><a class="dr-icon   dr-icon-cloud" href="#">Copia de Seguridad</a></li>
...
<div class="container">
  ...
  <div class="col-md-12 head">
    <h1 class="icon icon-search text-center"> CONSULTA</h1>
  </div>
...
<a href="#" class="consultar actualizar" id="Actualizar" onclick="actualizar()" title="Actualizar Administrador" ><h1 class="icon    icon-redo"></h1></a>
...
$query="SELECT * FROM usuario  WHERE Rol='Consulta'";
...
var contraseña_actual=document.getElementById('contraseña_actual').value;
var contraseña_nueva=document.getElementById('contraseña_nueva').value;
$('#contenedor').load('actualizar_contrasena_consulta.php',{Usuario:Usuario,contraseña_actual:contraseña_actual,contraseña_nueva:contraseña_nueva});
...
function validar_usuario () {
 ...
 function validar_contraseña_actual () {
      var contraseña_actual=document.getElementById('contraseña_actual').value;
 if (contraseña_actual.length>70) {
        $("#icono_texto").remove();//ACA ES PAFRA QUE NO SE REPITA LOS ICONOS CON EL ID DEL ESPAN QUE CREO CON EL OCONO
...
function validar_repita_contraseña () {
      var repita_contraseña=document.getElementById('repita_contraseña').value;
    if (repita_contraseña.length>70) {
        $("#icono_texto").remove();//ACA ES PAFRA QUE NO SE REPITA LOS ICONOS CON EL ID DEL ESPAN QUE CREO CON EL OCONO
