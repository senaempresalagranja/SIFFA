		...
		<nav class="dr-menu">
			...
			<ul>
				...
				<li  class="submenu" id="captura_datos"><a id="submenu" class="dr-icon dr-icon-pencil2"    href="#" >Captura de Datos</a>
					...
					<li><a class="dr-icon dr-icon-stats-dots" href="../interpretacion/calcular.php">Interpretacion analisis laboratorio</a>
					</li>
					<li><a class="dr-icon dr-icon-stats-dots" href="../analisis_reg/calcular.php">Analisis laboratorio</a>
		...
		<div class="container-fluid  ">
			...
			<form action="" id="formulario" method="POST">
				<div class="table-responsive">
					<div class="col-md-12">
						<h1>INTERPRETACION ANALISIS DE LABORATORIO</h1>
					</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<label for="">Elige Un Cultivo</label>

							<div id="elemento_cultivo">
								<div id="contenedor_cultivo">
									<?php $connection=mysqli_connect("localhost","root","","siffa");

									$query="SELECT * FROM cultivo ";
									$resource=mysqli_query($connection,$query);

									echo "<select name='cultivo' id='cultivo' onclick='mostrar_tamaño_cultivo()' class=' form-control'>";
									echo "<option value='Selecciona'  >Selecciona</option>";
					...
					<div >
						...
						<table class="table table-bordered table-condensed table-hover table-responsive" >
							<tr>
								...
								<td id="elemento_hectarea"><input class="form-control" id="hectarea" name="hectarea" type="text"  step="any">
									<span class="help-block"></span>
								</td>
								...
								<tr class="warning text-center">
									...
									<tr class="text-center">
										...
										<tr class="text-center" style="display:none" id="fila_nivel" >
											...
											<tr>
												<td><input type="button" value="Interpretar" id="calcular" class="interpretar btn btn-danger"> <span class="icon icono_interpretar  icon-spinner4"></span></td>
												...
												<td><input type="button" value="Plan Nutricional"  onclick="exportar()" style="display:none" id="plan" onclick="plan_nutricional()"  class="btn btn-success  plan "><span style="display:none" id="icono_plan" class="icon icono_plan   icon-table2"></span></td>
												<td><input type="button" style="display:none" value="Fetilizantes Necesario" id="fetilizante"   onclick="mostrar_fetilizantes()" style="display:none" class="btn btn-success  plan "><span  id="icono_fetilizante" class="icon  icon-lab"></span></td>

												<td><input type="button" value="Exportar Excel"  onclick="exportar_excel()" class="interpretar btn btn-danger"> <span class="icon icono_guardar icon-file-excel"></span></td>
											</tr>
										</table>
									</form>
						...
						<table class="table table-bordered">
								...
								<tr>
									<td>Resultado</td>
									<td ><p id="resultado_PH" class="form-control text-center"></p></td>
									<td id="resultado_MO" class="form-control text-center"></td>
									<td id="resultado_P"class="form-control text-center"></td>
									<td id="resultado_Al" class="form-control text-center"></td>
									<td id="resultado_Ca" class="form-control text-center"></td>
									<td id="resultado_Mg" class="form-control text-center"></td>
									<td id="resultado_K" class="form-control text-center"></td>
									<td id="resultado_Na" class="form-control text-center"></td>
									<td id="resultado_CICE" class="form-control text-center"></td>
									<td id="resultado_S" class="form-control text-center"></td>
...
<div class="row">
	...
	<div class="col-md-6">
		<div id="porcentaje_bases" class="exportar1" style="height: 450px"></div>
	</div>

	<div class="col-md-6">
		<div id="analisis_global" class="exportar1" style="height: 450px"></div>
...
<!-- ACA VA PARA PONER LA VENTANA EMERGENTE DE LAS FUENTES DE ENCALAMIENTO -->
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h1>Selecciona la Fuente de Encalamiento</h1>
				</div>
				<div class="modal-body">
					<div class="container-fluid">
						<div class="col-md-12">
							<table class="table table-bordered  ">
								<tr class="success">
									<td>MATERIAL ENCALANTE</td>
									<td>PRNT</td>
									<td>CONTENIDOS GARANTIZABLES</td>
								</tr>
								<tr>
									<td><input type="button" value="Carbonato de Calcio (Puro)" class="btn form-control"></td>
									<td>100</td>
									<td>(100% CaCO3)</td>
								</tr>
								<tr>
									<td><input type="button" value="Cal Dolomita" class="btn form-control"></td>
									<td>94</td>
									<td>(55% CaCO3+ 33%MgCO3)</td>
								</tr>
								<tr>
									<td><input type="button" value="Roca Fosfórica" class="btn form-control"></td>
									<td>69</td>
									<td><p>(P2O5=26% + CaO= 39 %)</p> <p>(FluorMáximo:4%)</p></td>
								</tr>
								<tr>
									<td><input type="button" value="Yeso Agrícola" class="btn form-control"></td>
									<td>51</td>
									<td>CaSO4 = 86,7%.</td>
								</tr>
								<tr>
									<td><input type="button" value="Kieserita" class="btn form-control"></td>
									<td>83</td>
									<td>MgSO4= 77,6% + H2O.</td>
								</tr>
								<tr>
									<td><input type="button" value="Hidróxido de Calcio" class="btn form-control"></td>
									<td>138</td>
									<td>Ca(OH)2</td>
								</tr>
								<tr>
									<td><input type="button" value="Oxidode Calcio" class="btn form-control"></td>
									<td>178</td>
									<td>CaO(Puro)</td>
								</tr>
								<tr>
									<td><input type="button" value="Oxidode Magnesio" class="btn form-control"></td>
									<td>248</td>
									<td>MgO</td>
								</tr>
							</table>
				...
				<div class="modal-footer">
					<a href="#" data-dismiss="modal" class="btn btn-danger">Cancelar Encalamiento</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="consultar_analisis" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h1 class="modal-title">BUSCAR ANALISIS</h1>
				</div>
				<div class="modal-body">
					<div class="col-md-12">
...
function exportar_excel() {
	var formulario=document.getElementById('formulario').action="exportar_excel/exportar_analisis.php";
...
function barrasmoviles() {

// var fertilizante_compuesto=document.getElementById('fertilizante_compuesto').value;
// var cultivo_select=document.getElementById('cultivo').value;
// $("#analisis").load("barras_movibles.php",{cultivo_select:cultivo_select,fertilizante_compuesto:fertilizante_compuesto});
}
function inicio() {
...
function mostrar_cultivo1() {

	var lote1=document.getElementById('lote1').value;

	$("#contenedor_muestra").load("mostrar_cultivo1.php",{lote1:lote1});
...
function mostrar_analisis() {
	var id_analisis=document.getElementById('id_analisis').value;
	$('#tamaño').load("mostrar_analisis.php",{id_analisis:id_analisis});
...
function mostrar_tamaño_cultivo () {
	var lote1=document.getElementById('lote').value;
	var cultivo=document.getElementById('cultivo').value;

	$("#tamaño").load("mostrartamano.php",{cultivo:cultivo,lote1:lote1});
...
function enviar1() {
	...
	if (  validar_numero_muestra()==true  && validar_laboratorio()==true && validar_finca()==true && validar_lote()==true && validar_cultivo()==true && validar_hectarea()==true && validar_profundidad()==true && validar_clima()==true && validar_densidad_aparente()==true && validar_PH()==true && validar_MO()==true  && validar_P()==true && validar_Al()==true && validar_Ca()==true && validar_Mg()==true &&
	...
	var cultivo=document.getElementById('cultivo').value;
														...
														$("#contenedor").load("guardar_analisis.php",{cultivo:cultivo,lote:lote,numero_muestra:numero_muestra, laboratorio:laboratorio, clima:clima,profundidad:profundidad,densidad_aparente:densidad_aparente,hectarea:hectarea,PH:PH, MO:MO, P:P, Al:Al, Ca:Ca, Mg:Mg , K:K, Na:Na, CICE:CICE, S:S, Fe:Fe, Mn:Mn, Cu:Cu, Zn:Zn, B:B, porcentaje_Al:porcentaje_Al, porcentaje_Na:porcentaje_Na, CE:CE})
