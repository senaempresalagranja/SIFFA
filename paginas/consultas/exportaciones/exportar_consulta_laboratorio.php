...
$sql="SELECT Nombre_Laboratorio,Direccion, Telefono ,Nombre_Municipio, NombreDepartamento FROM `laboratorio` INNER JOIN municipio ON laboratorio.Idmunicipio=municipio.Idmunicipio INNER JOIN departamento ON municipio.Iddepartamento=departamento.Iddepartamento WHERE Nombre_Laboratorio LIKE '%$Nombre_Laboratorio%' AND Nombre_Municipio LIKE '%$municipio%'";
...
// NOMBRE DEL ARCHIVO
$pdf->Output('Consulta_Laboratorios.pdf', 'I');
