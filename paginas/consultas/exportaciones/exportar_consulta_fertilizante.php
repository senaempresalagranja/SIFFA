...
$sql="SELECT * FROM fertilizantes WHERE NombreFertilizante LIKE '%$Nombre_Fertilizante%' ";
...
<h1>FERTILIZANTES BASE DE DATOS SIFFA</h1>
<table >
			<tr>
...
foreach ($lotes as $row) {
	$NombreFertilizante=$row["NombreFertilizante"];
...
// NOMBRE DEL ARCHIVO
$pdf->Output('Consulta_Fetilizante.pdf', 'I');
