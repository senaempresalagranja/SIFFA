...
// Con el siguiente bloque de código podemos escribir en la casilla que deseamos, es muy sencillo el manejo tanto para hacerlo manualmente como dinámicamente.
  ...
  $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B7', 'Lote (Ha)')
            ->setCellValue('C7', 'Cultivo')
            ->setCellValue('D7', 'Cultivo (Ha)')
            ->setCellValue('E7', 'Latitud')
            ->setCellValue('F7', 'Longitud')
            ->setCellValue('G7', 'Finca')
            ->setCellValue('H7', 'Finca (Ha)')
...
while ($fila=mysqli_fetch_row($resource)) {
    ...
    $objPHPExcel->setActiveSheetIndex(0)
     ...
     $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('B'.$y, $fila[5])
            ->setCellValue('C'.$y, $fila[2])
            ->setCellValue('D'.$y, $fila[1])
            ->setCellValue('E'.$y, $fila[3])
            ->setCellValue('F'.$y, $fila[4])
...
header('Content-Disposition: attachment;filename="Consulta_LoteCultivo.xls"');
