...
<div class="container">
<div class="row">
  <h1 class="text-center icon   icon-checkmark">  Solucion</h1>
</div>
  <div class="row">
  <div class="col-xs-2 col-sm-3 col-md-3">
    <img src="../../img/slide001.png" alt="" class="img-responsive img robot">
  </div>
<div class="col-md-9">
  <h3>La solucion a su Inquietud se encuentra en este Archivo</h3>

<h1 class=><a class="archivo icon icon-file-pdf" title="Descargar Solucion" href="#"></a></h1>
</div>
